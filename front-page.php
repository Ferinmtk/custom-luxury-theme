...
<main id="main">
	...
	<section class="descent" id="descent">
		<div class="d-pin">
			...
			<div class="d-cue" id="dCue" aria-hidden="true"><?php esc_html_e( 'Scroll to descend', 'luxury-homes' ); ?><i></i></div>
		</div>
	</section>
	...
	<section class="hww" id="how-we-work" data-nav="dark">
		...
		<svg class="hww-svg" viewBox="0 0 1400 470" fill="none" role="img"
			...
			<path d="M 40 404 C 180 372, 300 420, 460 396 C 640 370, 900 416, 1120 398 C 1220 391, 1300 402, 1360 398" stroke="#C2A55E" stroke-width="0.75" opacity="0.12"></path>
			<path d="M 40 432 C 240 414, 420 444, 640 428 C 880 411, 1120 442, 1360 426" stroke="#C2A55E" stroke-width="0.75" opacity="0.07"></path>

			<path class="anim hww-thread" d="M 118 366 C 175 338, 225 396, 320 368 C 420 341, 490 392, 590 374 C 680 358, 750 380, 850 376 L 850 258 L 1000 196 L 1060 220.8 L 1060 190 L 1090 190 L 1090 233.2 L 1150 258 L 1150 376 L 1360 376" stroke="url(#hww-gold)" stroke-width="1.25" stroke-linejoin="round"></path>
			<path class="anim hww-thread" d="M 118 382 C 175 354, 225 384, 320 376 C 420 352, 490 398, 590 366 C 680 366, 750 370, 850 383 L 857 383 L 857 265 L 1000 206 L 1057 229 L 1057 197 L 1083 197 L 1083 237 L 1143 262 L 1143 383 L 1360 376" stroke="#E9EDE0" stroke-width="0.9" stroke-linejoin="round" opacity="0.75"></path>

			<path class="anim fade d1" d="M 34 378 L 122 378" stroke="#C2A55E" stroke-width="0.75" opacity="0.35"></path>
			...
			<circle class="anim fade d6" cx="1360" cy="376" r="4.5" fill="none" stroke="#E3D294" stroke-width="1"></circle>
			<circle class="anim fade d6" cx="1360" cy="376" r="1.8" fill="#E3D294"></circle>

			<line class="anim fade d3" x1="300" y1="390" x2="300" y2="402" stroke="#C2A55E" stroke-width="0.75" opacity="0.6"></line>
			<line class="anim fade d4" x1="640" y1="378" x2="640" y2="402" stroke="#C2A55E" stroke-width="0.75" opacity="0.6"></line>
			<line class="anim fade d5" x1="1000" y1="390" x2="1000" y2="402" stroke="#C2A55E" stroke-width="0.75" opacity="0.6"></line>
			<text class="anim fade d3 hww-caps" x="300" y="424" text-anchor="middle" font-size="9.5"><?php echo esc_html( lh_field( 'hww_ms_1', __( 'DESIGNED, TOGETHER', 'luxury-homes' ) ) ); ?></text>
			<text class="anim fade d4 hww-caps" x="640" y="424" text-anchor="middle" font-size="9.5"><?php echo esc_html( lh_field( 'hww_ms_2', __( 'BROKE GROUND', 'luxury-homes' ) ) ); ?></text>
			<text class="anim fade d5 hww-caps" x="1000" y="424" text-anchor="middle" font-size="9.5"><?php echo esc_html( lh_field( 'hww_ms_3', __( 'WALKED EVERY ROOM', 'luxury-homes' ) ) ); ?></text>

			<text class="anim fade d1 hww-caps-gold" x="40" y="460" text-anchor="start" font-size="10"><?php echo esc_html( lh_field( 'hww_start', __( 'WEEK ONE — YOU MEET YOUR BUILDER', 'luxury-homes' ) ) ); ?></text>
			<text class="anim fade d6 hww-caps-gold" x="1360" y="460" text-anchor="end" font-size="10"><?php echo esc_html( lh_field( 'hww_end', __( 'MONTH EIGHTEEN — KEYS, HAND TO HAND', 'luxury-homes' ) ) ); ?></text>
			<text class="anim fade d6 hww-note" x="1000" y="164" text-anchor="middle" font-size="21"><?php echo esc_html( lh_field( 'hww_home_note', __( 'your home', 'luxury-homes' ) ) ); ?></text>
			<text class="anim fade d4 hww-note-muted" x="470" y="318" text-anchor="middle" font-size="18"><?php echo esc_html( lh_field( 'hww_crossing', __( 'every crossing, a conversation', 'luxury-homes' ) ) ); ?></text>

			<circle class="hww-comet" r="8" fill="#E3D294" opacity="0.4" filter="url(#hww-glow)">
				<animateMotion id="hww-m1" begin="indefinite" dur="10s" repeatCount="1" fill="freeze" calcMode="linear" path="M 118 366 C 175 338, 225 396, 320 368 C 420 341, 490 392, 590 374 C 680 358, 750 380, 850 376 L 850 258 L 1000 196 L 1060 220.8 L 1060 190 L 1090 190 L 1090 233.2 L 1150 258 L 1150 376 L 1360 376"></animateMotion>
			</circle>
			<circle class="hww-comet" r="2.5" fill="#C2A55E">
				<animateMotion id="hww-m2" begin="indefinite" dur="10s" repeatCount="1" fill="freeze" calcMode="linear" path="M 118 366 C 175 338, 225 396, 320 368 C 420 341, 490 392, 590 374 C 680 358, 750 380, 850 376 L 850 258 L 1000 196 L 1060 220.8 L 1060 190 L 1090 190 L 1090 233.2 L 1150 258 L 1150 376 L 1360 376"></animateMotion>
			</circle>
			<circle class="hww-comet" r="2.2" fill="#E9EDE0">
				<animateMotion id="hww-m3" begin="indefinite" dur="10s" repeatCount="1" fill="freeze" calcMode="linear" path="M 118 382 C 175 354, 225 384, 320 376 C 420 352, 490 398, 590 366 C 680 366, 750 370, 850 383 L 857 383 L 857 265 L 1000 206 L 1057 229 L 1057 197 L 1083 197 L 1083 237 L 1143 262 L 1143 383 L 1360 376"></animateMotion>
			</circle>
		</svg>
		...
		<ol class="hww-steps">
			<li><span><?php echo esc_html( lh_field( 'hww_start', __( 'WEEK ONE — YOU MEET YOUR BUILDER', 'luxury-homes' ) ) ); ?></span></li>
			<li><span><?php echo esc_html( lh_field( 'hww_ms_1', __( 'DESIGNED, TOGETHER', 'luxury-homes' ) ) ); ?></span></li>
			<li><span><?php echo esc_html( lh_field( 'hww_ms_2', __( 'BROKE GROUND', 'luxury-homes' ) ) ); ?></span></li>
			<li><span><?php echo esc_html( lh_field( 'hww_ms_3', __( 'WALKED EVERY ROOM', 'luxury-homes' ) ) ); ?></span></li>
			<li><span><?php echo esc_html( lh_field( 'hww_end', __( 'MONTH EIGHTEEN — KEYS, HAND TO HAND', 'luxury-homes' ) ) ); ?></span></li>
		</ol>
		...
		<a class="hww-cta" href="<?php echo esc_url( home_url( '/how-we-build/' ) ); ?>"><?php esc_html_e( 'See how we build', 'luxury-homes' ); ?> <span aria-hidden="true">&rarr;</span></a>
	</section>

	<!-- ============ CONTACT ============ -->
	<?php
	$lh_tel = trim( (string) lh_field( 'contact_phone', '' ) );
	$lh_who = trim( (string) lh_field( 'contact_person', '' ) );
	?>
	<section class="contact" id="contact" data-nav="dark">
		<div class="contact__inner">
			<p class="contact__eyebrow"><?php echo esc_html( lh_field( 'contact_eyebrow', __( 'Begin', 'luxury-homes' ) ) ); ?></p>

			<h2 class="contact__title"><?php echo esc_html( lh_field( 'contact_heading', __( 'Tell us about your land.', 'luxury-homes' ) ) ); ?></h2>

			<p class="contact__teaser"><?php echo esc_html( lh_field( 'contact_teaser', __( 'A short note about the site and how you live is all it takes to start.', 'luxury-homes' ) ) ); ?></p>

			<form class="contact__start" action="<?php echo esc_url( home_url( '/contact/' ) ); ?>" method="get">
				<label class="screen-reader-text" for="lhEmail"><?php esc_html_e( 'Your email address', 'luxury-homes' ); ?></label>
				<input
					...
					inputmode="email"
					autocomplete="email"
					placeholder="<?php esc_attr_e( 'your email', 'luxury-homes' ); ?>"
					required
				>
				<button class="contact__submit" type="submit">
					<?php esc_html_e( 'Begin', 'luxury-homes' ); ?> <span aria-hidden="true">&rarr;</span>
				</button>
			</form>

			<?php if ( '' !== $lh_tel ) : ?>
				<p class="contact__call">
					<?php
					$tel_href = 'tel:' . preg_replace( '/[^0-9+]/', '', $lh_tel );
					if ( '' !== $lh_who ) {
						printf(
							/* translators: 1: person's name, 2: telephone link */
							esc_html__( 'Or call %1$s directly · %2$s', 'luxury-homes' ),
							esc_html( $lh_who ),
							'<a href="' . esc_url( $tel_href ) . '">' . esc_html( $lh_tel ) . '</a>'
						);
					} else {
						printf(
