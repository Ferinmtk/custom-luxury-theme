							...
							<div class="sc-info">
								...
								<?php if ( $is_last ) : ?>
									<span class="sc-actions">
										<a class="sc-btn" href="<?php echo esc_url( $home_url ); ?>"><?php esc_html_e( 'Tour this home', 'luxury-homes' ); ?> &rarr;</a>
										<a class="sc-morelink" href="<?php echo esc_url( home_url( '/our-homes/' ) ); ?>"><?php esc_html_e( 'See all homes', 'luxury-homes' ); ?> &rarr;</a>
									</span>
								<?php else : ?>
		...
		<div class="ways-in">
			...
			<div class="ways-grid" data-reveal>
				<?php foreach ( $lh_ways as $lh_i => $lh_w ) :
					...
					?>
					<a class="ways-card<?php echo esc_attr( $lh_gold ); ?>" href="<?php echo esc_url( home_url( isset( $lh_w['link'] ) ? $lh_w['link'] : '/contact/' ) ); ?>" style="--tone: <?php echo esc_attr( $lh_w['tone'] ); ?>;">
						<span class="ways-card__inner">
							<span class="ways-card__front">
								<span class="ways-card__icon"><?php echo lh_option_icon( $lh_w['icon'] ); // phpcs:ignore ?></span>
			...
			<div class="ways-foot" data-reveal>
				...
				<a class="ways-btn" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"><span class="ways-btn__label"><?php esc_html_e( 'Start the conversation', 'luxury-homes' ); ?></span><span class="ways-btn__arrow" aria-hidden="true">&rarr;</span></a>
