...
?>
    ...
    <main id="main" class="homes-page our-homes-page">
        ...
        <?php while (have_posts()) : the_post(); ?>
            <section class="homes-hero">
                <div class="homes-hero-in">
                    ...
                    <?php else : ?>
                        <div class="homes-intro" data-reveal><p>Every home here was drawn from its land and stick-built
                                on-site. One family, one site, one home at a time.</p></div>
                    <?php endif; ?>
                    <?php if ($all_homes) : ?>
        ...
        <?php if ($featured) :
            ...
            if ($fm['baths']) {
                $fspec[] = $fm['baths'] . ' baths';
            }
            if ($fm['sqft']) {
                $fspec[] = number_format_i18n((float)$fm['sqft']) . ' sq ft';
            }
            if ($fm['year']) {
                $fspec[] = 'Completed ' . $fm['year'];
            }
            ?>
        ...
        <section class="homes-grid-wrap" aria-labelledby="homesGridHeading">
            <div class="hm-archbg" aria-hidden="true"><img class="hm-archbg-img"
                                                           src="<?php echo lh_asset('img/blueprint.svg'); ?>" alt=""
            ...
            <?php if ($rest) : ?>
                ...
                <?php if ($filter_styles) : ?>
                    <div class="hm-filters" id="hmFilters" role="group" aria-label="Filter homes by style" data-reveal>
                        <button type="button" class="hm-filter is-active" data-filter="*" aria-pressed="true">All
                        </button>
                        <?php foreach ($filter_styles as $s) : ?>
                            <button type="button" class="hm-filter" data-filter="<?php echo esc_attr($s); ?>"
                                    aria-pressed="false"><?php echo esc_html($s); ?></button>
                        <?php endforeach; ?>
                    </div>
                <?php endif; ?>
                ...
                <div class="homes-grid" id="homesGrid">
                    <?php foreach ($rest as $post) : setup_postdata($post);
                        ...
                        <a class="home-card" href="<?php echo esc_url(get_permalink($post)); ?>"
                           data-style="<?php echo esc_attr($meta['style']); ?>" data-reveal>
                            <div class="frame">
                                <?php if ($meta['style']) : ?>
            ...
            <?php else : ?>
                <p class="homes-empty">Homes are coming soon. In the meantime, <a
                            href="<?php echo esc_url(home_url('/contact/')); ?>">tell us about yours</a>.</p>
            <?php endif; ?>
        </section>
            ...
            <div class="hm-values-in">
                ...
                <div class="hm-values-grid" data-reveal>
                    ...
                    <div class="hm-value">
                        ...
                        <h3>Colorado craft</h3>
                        <p>Master trades from the Front Range, working stone, timber and glass by hand.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="hm-cta">
            <div class="hm-cta-in">
                <figure class="hm-cta-media" data-reveal>
                    <img src="<?php echo lh_asset('img/cta-planning.jpg'); ?>"
                         alt="A modern custom home rendered above its architectural plans" loading="lazy"
                ...
                <div class="hm-cta-copy" data-reveal>
                    ...
                    <a class="sh-btn hm-cta-btn" href="<?php echo esc_url(home_url('/contact/')); ?>"><span>Start the conversation</span><i
                                aria-hidden="true">&rarr;</i></a>
                </div>
            </div>
        </section>
