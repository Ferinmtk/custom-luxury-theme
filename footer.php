<footer class="site-footer">
    <div class="site-footer__inner">
        ...
        <div class="site-footer__brandcol">
            <a class="site-footer__wordmark"
               href="<?php echo esc_url(home_url('/')); ?>"><?php echo esc_html(lh_company()); ?></a>
            ...
            <ul class="site-footer__social" aria-label="<?php esc_attr_e('Social', 'luxury-homes'); ?>">
                ...
                foreach ($lh_socials as $lh_s) :
                    ...
                    ?>
                    <li><a href="<?php echo esc_url($lh_s['url']); ?>"
                           aria-label="<?php echo esc_attr($lh_s['label']); ?>"<?php echo $lh_ext; // phpcs:ignore
                        ?>><?php echo lh_social_icon($lh_s['icon']); // phpcs:ignore
                            ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
        ...
        <nav class="site-footer__col" aria-label="<?php esc_attr_e('Footer', 'luxury-homes'); ?>">
            ...
            <ul class="site-footer__links">
                <?php foreach (lh_nav_items() as $lh_item) : ?>
                    <li><a href="<?php echo esc_url($lh_item['url']); ?>"><?php echo esc_html($lh_item['label']); ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </nav>
